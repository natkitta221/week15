...
@section('content')
    ...
    <div class="edit-container">
        ...
        <div class="edit-card">
            ...
            <p class="form-header-subtitle">ปรับปรุงเนื้อหาและข้อความบทความของคุณ</p>
            ...
            <form method="POST" action="{{ route('update', $blog->id) }}">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="title" class="form-control @error('title') is-invalid @enderror" name="title" value="{{ old('title', $blog->title) }}">
                    @error('title')
                ...
                <div class="mb-4">
                    ...
                    <textarea name="content" id="content" class="form-control @error('content') is-invalid @enderror" cols="30" rows="6">{{ old('content', $blog->content) }}</textarea>
                    @error('content')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
